...
color:#3a3632;background:#f7f5f0;border:1px solid #e6e1d8;border-radius:12px;line-height:1.3}
...
padding:15px 16px}
.case .th{flex:0 0 auto;width:62px;height:62px;border-radius:12px;object-fit:cover;
...
.card{background:#161616;border:1px solid #232323;border-radius:12px;padding:20px 22px}
...
.ref .ic{flex:0 0 auto;width:34px;height:34px;border-radius:12px;background:#F0704018;
...
.cta{background:linear-gradient(180deg,#1c1a17,#161514);border:1px solid #3a2b20;border-radius:12px;
...
border-radius:12px;font-size:1rem;letter-spacing:-.01em}
...
<p class="lead">광고 한 가지가 아닙니다. 순살의 콘텐츠·채널·독자와 만나는 자리 가운데
어디에 브랜드를 얹을지에 따라 형태가 달라집니다. <b style="color:#ccc">아래에서 고르시면
그에 맞춰 견적을 드립니다.</b></p>
