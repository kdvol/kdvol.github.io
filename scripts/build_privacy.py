...
<p>또 하나는 광고 지표입니다. 회사 메일 보안이 링크를 자동으로 눌러 보는 경우가 있어,
클릭 수에 사람이 아닌 것이 섞입니다. <b>실제 사람이 읽은 수</b>를 광고주에게 정확히
드리려면 셀 수 있어야 합니다.</p>
<p><b>쓰는 곳은 아래 일곱 가지입니다.</b> 여기 없는 용도로는 쓰지 않습니다.</p>
<ol class="uses">
<li>회차별로 몇 명이 읽었는지, 다시 오셨는지 세는 것</li>
<li>어떤 글·주제가 읽히는지 보고 다음 편성에 반영하는 것</li>
<li>구독자군별 열람 경향 — 가입 시점, 본인이 고르신 관심분야 같은 <b>집단 단위</b>
분석 (개인을 짚지 않습니다)</li>
<li>안 읽으신 지 오래된 분께 다시 안내드릴지 판단하는 것</li>
<li>광고주에게 드릴 <b>집계 지표</b>를 만드는 것 — 개인을 알아볼 수 있는 정보는
드리지 않습니다</li>
<li>오류나 부정 이용(사람이 아닌 자동 클릭 등)을 확인하는 것</li>
...
<h2>건강 같은 민감한 주제는 빼둡니다</h2>
<div class="box no">
<p>순살은 금융 매체지만 비만 치료제·우울증 신약처럼 <b>건강 관련 소재</b>를 자주
다룹니다. 이런 글을 읽으셨다는 사실이 구독자 개인과 연결되어 남으면 곤란합니다.</p>
<p>그래서 <b>건강 관련 주제 페이지와 위키 페이지는 구독자 표시와 함께 기록하지
않습니다.</b> 날짜별 방문 합계로만 셉니다.</p>
<p>회차 페이지는 한 장에 여러 글이 담겨 있어 "그중 어느 글을 읽었는지"가
특정되지 않으므로 그대로 셉니다.</p>
</div>
