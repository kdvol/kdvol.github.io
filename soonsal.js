...
/* soonsal-mobile-first-20260924 */
(function(){var s=document.createElement("style");s.id="soonsal-mobile-policy";s.textContent="\n@media(max-width:640px){\n.site-header{grid-template-columns:44px minmax(0,1fr) auto;min-height:64px;gap:8px;padding-left:12px;padding-right:12px}\n.site-header .search-btn-header{width:44px;height:44px;min-width:44px;min-height:44px;display:inline-flex;align-items:center;justify-content:center}\n.site-header .sub-btn-header{min-height:44px;display:inline-flex;align-items:center;justify-content:center;padding:8px 10px}\n.site-header .logo-link{min-width:0;min-height:44px;display:inline-flex;align-items:center;justify-content:center;gap:6px}\n.site-header .logo-text{font-size:clamp(11px,3.8vw,15px);white-space:nowrap}\n.site-header .logo-link img{width:22px;height:22px;object-fit:contain}\n.nav>a,.nav-more>summary{min-height:44px;display:flex;align-items:center;justify-content:center}\n.nav-menu a{min-height:44px;display:flex;align-items:center;justify-content:center;white-space:normal;word-break:keep-all}\ninput:not([type=checkbox]):not([type=radio]),select,textarea{font-size:16px!important;max-width:100%;min-width:0}\nbutton,.ss-rb,.ss-save,.chip,.crumb,.sub-btn{min-height:44px;touch-action:manipulation}\n.chip{display:inline-flex;align-items:center;justify-content:center}\n.ss-modal{max-width:calc(100vw - 24px);max-height:calc(100dvh - 32px);overflow-y:auto}\n.ss-modal-bg{padding:12px}\n}\n@media(prefers-reduced-motion:reduce){html{scroll-behavior:auto!important}.stk-track{animation:none!important}}\n";document.head.appendChild(s);})();
/* /soonsal-mobile-first-20260924 */
